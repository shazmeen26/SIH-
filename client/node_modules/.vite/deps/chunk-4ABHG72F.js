...
import {
  ...
  useMounted,
  usePrevious
} from "./chunk-JE7KCDDM.js";
import {
  require_classnames,
  useBootstrapPrefix
} from "./chunk-S6G5UDCS.js";
import {
  _inheritsLoose
} from "./chunk-A5GOUSMR.js";
import {
  require_react_dom
...
var ModalManager = class {
  ...
  setContainerStyle(containerState) {
    ...
    if (containerState.scrollBarWidth) {
      style3[paddingProp] = `${parseInt(css_default(container, paddingProp) || "0", 10) + containerState.scrollBarWidth}px`;
    }
    container.setAttribute(OPEN_DATA_ATTRIBUTE, "");
    css_default(container, style3);
  }
  reset() {
...
function style2(node, property) {
  ...
  var transforms = "";
  if (typeof property === "string") {
    return node.style.getPropertyValue(hyphenateStyleName2(property)) || getComputedStyle2(node).getPropertyValue(hyphenateStyleName2(property));
  }
  Object.keys(property).forEach(function(key) {
    var value = property[key];
    if (!value && value !== 0) {
...
function parseDuration(node) {
  var str = css_default2(node, "transitionDuration") || "";
...
function emulateTransitionEnd(element, duration, padding) {
  ...
  var remove = listen_default2(element, "transitionend", function() {
    called = true;
  }, {
    once: true
  });
...
function transitionEnd(element, handler, duration, padding) {
  ...
  var remove = listen_default2(element, "transitionend", handler);
  return function() {
    removeEmulate();
    remove();
  };
...
function parseDuration2(node, property) {
  const str = css_default2(node, property) || "";
...
var BootstrapModalManager = class extends ModalManager_default {
  adjustAndStore(prop, element, adjust) {
    ...
    css_default2(element, {
      [prop]: `${parseFloat(css_default2(element, prop)) + adjust}px`
    });
  }
...
//# sourceMappingURL=chunk-4ABHG72F.js.map
